...
public class Event extends DomainObject {
    ...
    private NavigableMap<LocalDateTime, HashSet<Ticket>> soldTickets = new TreeMap<>();
    ...
    public NavigableMap<LocalDateTime, HashSet<Ticket>> getSoldTickets() {
        return soldTickets;
    }

    public void addSoldTicket(LocalDateTime localDateTime, Ticket ticket) {
        soldTickets.get(localDateTime).add(ticket);
    }
